...
<body>
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-2">
                    <span class="h2">Tambah Data Handphone</span>
                    <a href="index.php" class="btn btn-primary btn-sm" style="float: right;">Kembali</a>
                </div>
                <form action="save.php" method="post">
                    <div class="input-group mb-3">
                        <input type="text" name="merk" class="form-control" placeholder="Merk Handphone*" aria-label="merk" aria-describedby="basic-addon1" required autofocus>
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" name="tipe" class="form-control" placeholder="Tipe Handphone" aria-label="tipe" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
